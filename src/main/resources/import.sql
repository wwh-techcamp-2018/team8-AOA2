...
insert into store ( address, address_detail, description, imgurl, owner_name, phone_number, post_code, service_description, store_name, user_id) values ('경기 안양시 동안구 엘에스로116번길 56 (호계동, 안양호계푸르지오)', '101동 301호', '안녕 나는 코딩하느라 힘들어 여기서 마카롱을 사준다면 내가좀 나아질것 같구나 ', '/uploads/test.png', '김연태', '01043444441', '14118', '연태가 운영하는 맛있는 마카롱가게', '연태가게', 2)
